      ...
      <div className="mx-auto max-w-2xl space-y-10 py-8 sm:max-w-4xl">
        ...
        <section className="text-center">
          ...
          <div className="mt-8 flex flex-col gap-3 sm:flex-row sm:justify-center">
            ...
            <Link
              href="/pricing"
              className="inline-flex min-h-[48px] items-center justify-center rounded-xl border border-stone-300 bg-white px-6 text-base font-semibold text-stone-700 hover:bg-stone-50 active:bg-stone-100"
            >
              View pricing
            </Link>
            <Link
              href="/sign-in"
              className="inline-flex min-h-[48px] items-center justify-center rounded-xl px-6 text-base font-medium text-stone-600 hover:text-stone-900 active:text-stone-800"
            >
              Sign in
            </Link>
          </div>
