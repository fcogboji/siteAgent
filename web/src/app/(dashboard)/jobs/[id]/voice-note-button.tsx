...
export function VoiceNoteButton({ onTranscript, disabled }: Props) {
  ...
  return (
    <button
      ...
      className="inline-flex h-10 items-center gap-2 rounded-lg border border-stone-300 bg-white px-4 py-2 text-sm font-medium text-stone-700 shadow-sm hover:bg-stone-50 disabled:opacity-60"
    >
